...
--->
	...
	<body>
		...
		<div id="main">
			...
			<p>At OrthoSC, your needs are our highest concern. We understand how important it is for you to be seen in a 
			timely manner.&nbsp;For this reason, we make every effort to accommodate appointments immediately upon request.</p>
		<?php
	//NECESSARY VARIABLES
	$errormsg = "";
	$showform = 1;
